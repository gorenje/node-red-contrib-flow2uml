module.exports = function(RED) {
  function Coremermaid_state_endFunctionality(config) {
    ...
    node.on("input", function(msg, send, done) {
        ...
        node.status({ fill: "green", shape: "ring", text: RED._("mermaid-state-end.label.statusset") });
  ...
  RED.nodes.registerType("mermaid-state-end", Coremermaid_state_endFunctionality);
