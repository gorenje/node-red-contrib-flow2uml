module.exports = function(RED) {
  function Coremermaid_state_stateFunctionality(config) {
    ...
    node.on("input", function(msg, send, done) {
        ...
        node.status({ fill: "green", shape: "ring", text: RED._("mermaid-state-state.label.statusset") });
  ...
  RED.nodes.registerType("mermaid-state-state", Coremermaid_state_stateFunctionality);
