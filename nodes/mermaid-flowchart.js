module.exports = function(RED) {
  function Coremermaid_flowchartFunctionality(config) {
    ...
    node.on("input", function(msg, send, done) {
        ...
        node.status({ fill: "green", shape: "ring", text: RED._("mermaid-flowchart.label.statusset") });
  ...
  RED.nodes.registerType("mermaid-flowchart", Coremermaid_flowchartFunctionality);
